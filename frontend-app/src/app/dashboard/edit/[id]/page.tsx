      ...
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-6 sm:p-8 animate-pulse space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="h-11 w-full sm:w-32 rounded-md bg-zinc-900 border border-zinc-800" />
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <div className="h-11 w-full sm:w-20 rounded-md bg-zinc-900 border border-zinc-800" />
              <div className="h-11 w-full sm:w-28 rounded-md bg-zinc-800" />
            </div>
          </div>
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 backdrop-blur-sm p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-6">
              ...
              {/* INPUT GAMBAR ASET WITH LIGHTBOX */}
              <div className="space-y-2">
